...
import co.quchu.galleryfinal.adapter.FolderListAdapter;
import co.quchu.galleryfinal.adapter.PhotoListAdapter;
import co.quchu.galleryfinal.model.PhotoFolderInfo;
import co.quchu.galleryfinal.model.PhotoInfo;
import co.quchu.galleryfinal.utils.PhotoTools;
...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    private void setTheme() {
     ...
     /*   if (mThemeConfig.getIconBack() == R.drawable.ic_gf_back) {
        ...
        mIvBack.setImageDrawable(getResources().getDrawable(R.drawable.ic_title_back));
