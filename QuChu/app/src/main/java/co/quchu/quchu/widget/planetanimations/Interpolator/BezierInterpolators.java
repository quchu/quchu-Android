package co.quchu.quchu.widget.planetanimations.Interpolator;
 ...
 */
public class BezierInterpolators implements Interpolator {
    ...
    public BezierInterpolators(float x1, float y1, float x2, float y2) {
