package co.quchu.quchu.widget.RefreshLayout;
...
/**
 * Created by linqipeng on 2016/3/8 10:51
 * email:437943145@qq.com
 * desc:
 */

public class HorizontalSwipeRefLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = HorizontalSwipeRefLayout.class.getSimpleName();
     ...
     * @param context
     */
    public HorizontalSwipeRefLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public HorizontalSwipeRefLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
/// TODO: 2016/3/8
        ...
        mCircleView.layout(mCurrentTargetOffsetTop, (height / 2 - circleHeight / 2),
                mCurrentTargetOffsetTop + circleWidth, (height / 2 + circleHeight / 2));
    }
...
//                final float y = MotionEventCompat.getY(ev, pointerIndex);
                float y = MotionEventCompat.getX(ev, pointerIndex);
...
// TODO: 2016/3/8
                final float y = MotionEventCompat.getX(ev, pointerIndex);
//                final float y = MotionEventCompat.getY(ev, pointerIndex);
                final float overscrollTop = (y - mInitialMotionY) * DRAG_RATE;
                mIsBeingDragged = false;
