...
//        if ( !isInEditMode() ) {
//            ( (CareAboutFriendsActivity)context).addOnBackPressedListener(new OnBackPressedListener() {
//
//                @Override
...
//        toListModeSet.addListener( new Animator.AnimatorListener() {
//
//            @Override
...
//                PostCardRecyclerView.this.mode = Mode.LISTED;
//            }
//
//            @Override
...
//
//        toPickModeSet.addListener( new Animator.AnimatorListener() {
//
//            @Override
//            public void onAnimationStart( Animator animation ) {
//                if ( onCardSelectListener != null ) {
...
//            @Override
//            public void onAnimationEnd( Animator animation ) {
//                PostCardRecyclerView.this.mode = Mode.PICKED;
//            }
//
//            @Override
//            public void onAnimationCancel( Animator animation ) {
...
//
//        revertSet.addListener( new Animator.AnimatorListener() {
//
//            @Override
//            public void onAnimationStart( Animator animation ) {
//            }
...
//        LogUtils.json("childCount"+childCount);
...
//    }
//
//    interface DataListener<T extends Object> {
//
