 ...
 */
public class SearchResultActivityNew extends BaseBehaviorActivity {
  ...
  public static void launch(Activity activity, SearchCategoryBean categoryBean, String input, int position) {
    Intent intent = new Intent(activity, SearchResultActivityNew.class);
  ...
  private void initRecyclerView() {
    ...
    mSearchResultRv.setOnTouchListener(new View.OnTouchListener() {
      ...
      public boolean onTouch(View v, MotionEvent event) {
        SoftInputUtils.hideSoftInput(SearchResultActivityNew.this);
