...
public interface NetApi {
  ...
  String getNearby = HOST
      + "/place/nearPlaces?cityId=%d&latitude=%s&longitude=%s&pagesNo=%d&recommendPlaceIds=%s&categoryTagIds=%s&isFirst=%d&placeId=%d";
  ...
  String findPosition = HOST + "/operate/proposalPlace";//发现趣处
  ...
  String putGtClientById = HOST + "/public/putGtClientById";//个推id绑定
