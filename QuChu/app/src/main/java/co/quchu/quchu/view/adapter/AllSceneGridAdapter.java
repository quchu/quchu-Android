...
public class AllSceneGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public static final int TYPE_FOOTER = 0x0003;
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    if (viewType == TYPE_HEADER) {
      return new HeaderViewHolder(LayoutInflater.from(parent.getContext())
          .inflate(R.layout.item_scene_header, parent, false));
    } else if (viewType == TYPE_CONTENT) {
      return new ViewHolder(LayoutInflater.from(parent.getContext())
          .inflate(R.layout.item_recommend_grid, parent, false));
    } else {
  ...
  @Override public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
    ...
    if (holder instanceof ViewHolder) {
      ...
      if (null != mData.get(position).getSceneTitle()
          && mData.get(position).getSceneTitle().length > 0) {
  ...
  @Override public int getItemCount() {
    return null != mData ? mData.size() + 2 : 2;
  }
  ...
  public class FooterViewHolder extends RecyclerView.ViewHolder {
    ...
    @Bind(R.id.loadmore_massage) TextView loadmoreMassage;
  ...
  public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    @Bind(R.id.recommend_tag1) TextView tvTag1;
    @Bind(R.id.recommend_tag2) TextView tvTag2;
    @Bind(R.id.recommend_tag3) TextView tvTag3;
